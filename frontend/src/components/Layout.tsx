...
function AnimatedBackground() {
  return (
    ...
    <div className="fixed inset-0 z-[0] overflow-hidden pointer-events-none" aria-hidden>
      ...
      <div className="absolute top-1/3 -left-16 w-[220px] h-[220px] rounded-full border-2 border-dashed border-terra-400/25 animate-spin-slow" />
      ...
      <div className="absolute top-1/2 -right-32 w-[360px] h-[360px] rounded-full bg-amber-200/20 blur-3xl animate-pulse-soft" />
      {/* Tiny floating dots – scattered */}
      <div className="absolute top-[18%] left-[72%] w-2 h-2 rounded-full bg-amber-500/50 animate-float" />
      <div className="absolute top-[55%] left-[12%] w-1.5 h-1.5 rounded-full bg-terra-500/40 animate-float-delayed" />
      <div className="absolute top-[78%] left-[82%] w-2.5 h-2.5 rounded-full bg-forest-500/35 animate-float" />
      <div className="absolute top-[35%] left-[45%] w-1.5 h-1.5 rounded-full bg-amber-500/35 animate-float-delayed" />
    </div>
  )
}
