...
- **Contribute** -- send your contribution for the current cycle via \credits.aleo/transfer_public_as_signer- **Claim payout** -- the cycle winner claims the full pot via \credits.aleo/transfer_public- **Transfer membership** -- pass your circle position to another address
...
**Deployed program:** \zk_circles_v6.aleo**Deployment TX:** \t1z5rendz2gtpeq7u2ldsnmy8mrcvlxasn373n9j5j54v8t32lxcrsq7u7wh
### Transitions
...
| \contribute\ | Contribute for the current cycle | \	ransfer_public_as_signer\ to program address |
| \claim_payout\ | Claim the pot when it\'s your turn | \	ransfer_public\ to winner |
| \	ransfer_membership\ | Transfer your position to another address | -- |
| \erify_membership\ | Assert on-chain membership | -- |
...
| \ContributionReceipt\ | \owner\, \circle_id\, \cycle\, \mount\ |
...
| \contributions\ | \BHP256(circle_id, cycle, member_addr)\ -> \ool\ |
...
| Service | Config |
|---|---|
| Frontend | Vercel -- root dir: \rontend\ |
| Backend | Render -- root dir: \ackend\, start cmd: ode index.js\ |
